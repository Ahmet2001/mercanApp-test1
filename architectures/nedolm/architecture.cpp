...
const mercan_architecture_v1 NEDOLM_ARCH = {
    ...
    "NedoLM",
    "ndsurf004",
    MERCAN_ARCH_BACKEND_MANAGED_GRAPH | MERCAN_ARCH_BUILTIN | MERCAN_ARCH_GRAPH_ABI_V1_PRIMITIVES | MERCAN_ARCH_TENSOR_ABI_V1 | MERCAN_ARCH_KV_ABI_V1,
    nedolm_probe,
    nedolm_validate,
    nullptr, // backend-managed graph; external callback migration is separate
};
