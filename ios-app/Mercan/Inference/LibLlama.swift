...
actor LlamaContext {
    ...
    init(model: OpaquePointer, context: OpaquePointer) {
        ...
        guard let sampling = nedolm_silo_create_sampler_chain(model) else {
